...
const String _msgPackHubProtocolName = "messagepack";
const int _protocolVersion = 1;
const TransferFormat _defaultTransferFormat = TransferFormat.binary;

class MessagePackHubProtocol implements IHubProtocol {
  @override
  String get name => _msgPackHubProtocolName;
  @override
  TransferFormat get transferFormat => _defaultTransferFormat;
